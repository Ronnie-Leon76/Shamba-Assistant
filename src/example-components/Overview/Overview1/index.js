        ...
        <div className="hero-wrapper--content">
          ...
          <div className="bg-composed-wrapper--content">
            <Container className="z-over shadow-container-content-5 text-white text-center pt-5">
              ...
              >
                <h2 className="display-3 font-weight-bold">Shamba Assistant</h2>
                <p className="font-size-xl py-3 text-white-50">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Impedit ad debitis est nihil magni iure accusantium obcaecati
                  assumenda facilis, ea dicta consectetur dolorum autem officiis
                  quasi eum sit nam! Ut.
                </p>
              </Grid>
