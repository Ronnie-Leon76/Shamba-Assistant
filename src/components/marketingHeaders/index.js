...
import projectLogo from "../../assets/images/logos/shamba_assistant.svg";
        ...
        <div className="app-nav-logo flex-grow-0 app-nav-logo--dark mr-3">
          ...
          >
            <div className="app-nav-logo--icon rounded-circle">
              <img alt="Shamba Assistant" src={projectLogo} />
            </div>
                      ...
                      >
                        ...
                        >
                          <div className="d-flex">
                            ...
                            <div className="pl-3 text-black">
                              <div className="font-weight-bold">Market</div>
                              <div className="text-black-50 font-size-sm">
                                Connecting FarmHubs to FoodHubs
                              </div>
                            </div>
                          </div>
                        </ListItem>
                        ...
                        >
                          <div className="d-flex">
                            ...
                            <div className="pl-3 text-black">
                              <div className="font-weight-bold">Food Pharmacy</div>
                              <div className="text-black-50 font-size-sm">
